...
class TwoLayerNet(object):
    ...
    def __init__(
        ...
        self.params['W2']= np.random.normal(loc = 0, scale=  weight_scale,size = (hidden_dim,output_dim))
    ...
    def loss(self, X, y=None):
        ...
        loss, gsm = softmax_loss(l2,y)
        loss+=0.5*self.reg*(np.sum(self.params['W1']*self.params['W1']) + np.sum(self.params['W2']*self.params['W2'] ) )
        l2_dx, dW2, db2 =affine_backward(gsm,ch2)
        l1_dx, dW1, db1=affine_relu_backward(l2_dx,ch1)
